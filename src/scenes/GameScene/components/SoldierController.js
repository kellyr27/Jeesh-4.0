...
const SoldierController = () => {
    ...
    const [soldier1Rotation, setSoldier1Rotation] = useState([0, 0, 0])
    ...
    useFrame((state, delta) => {
        ...
        if (animationPhase.current === 'Phase 1') {
            ...
            if (t < 1) {
                ...
                setSoldier1Rotation(offsetRotation([rotation.x, rotation.y, rotation.z]))
            } else {
    ...
    return (
        <>
            <Soldier position={soldier1Position} rotation={soldier1Rotation} color={"#ff0000"} />
        </>
    )
}
